...
interface ModelTypes {
   ...
   */
  withPagination(data: QueryParams, searchTable?: SearchableTables): Promise<any>
}
...
ModelQueryBuilder.macro(
  ...
  function (this: ModelQueryBuilder, data: QueryParams, searchTable?: string) {
    return this.withArchivedStatus(data.archived)
      .betweenCreatedDates(data.startDate, data.endDate)
